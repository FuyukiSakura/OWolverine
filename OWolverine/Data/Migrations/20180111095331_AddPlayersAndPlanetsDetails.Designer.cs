...
namespace OWolverine.Data.Migrations
{
    ...
    [Migration("20180111095331_AddPlayersAndPlanetsDetails")]
    partial class AddPlayersAndPlanetsDetails
    {
            ...
            modelBuilder.Entity("OWolverine.Models.Ogame.Planet", b =>
                {
                    ...
                    b.HasIndex("OwnerId", "OwnerServer");
            ...
            modelBuilder.Entity("OWolverine.Models.Ogame.Planet", b =>
                {
                    ...
                    b.HasOne("OWolverine.Models.Ogame.Player", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerId", "OwnerServer");
                });
